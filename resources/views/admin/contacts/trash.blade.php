        ...
        <table id="example1" style="text-align: center" class="table table-bordered table-striped">
            <form action="{{ route('admin.contact.list') }}" method="get">
                <div class="d-flex mb-3">
                    <input type="text" name="name" value="{{ request('name') }}" class="form-control col-4"
                        style="margin-left: 100px" placeholder="Tìm kiếm theo Tên...">
                    <input type="text" name="email" value="{{ request('email') }}" class="form-control col-4"
                    ...
                    <td>
                        ...
                        <div class="btn-group dropleft">
                            ...
                            <div class="dropdown-menu dropleft" x-placement="left-start"
                                ...
                                <form action="{{route('admin.contact.trash.restore', $item->id)}}" method="post"
                                ...
                                <form action="{{route('admin.contact.trash.forceDelete', $item->id)}}" method="POST"
