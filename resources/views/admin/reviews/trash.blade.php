            ...
            <form action="{{ route('admin.review.list') }}" method="get">
                <div class="d-flex mb-3">
                    <select name="customer_id" class="form-control col-4" style="margin-left: 50px" id="">
                        ...
                        <option value="{{$item->id}}" @selected(request('customer_id')==$item->id)>{{$item->name}}
                        </option>
                        @endforeach
                    </select>
                    <select name="product_id" class="form-control col-4" style="margin-left: 50px" id="">
                        ...
                        <option value="{{$item->id}}" @selected(request('product_id')==$item->
                            id)>{{$item->ten_san_pham}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="d-flex mb-3">
                ...
                <div class="col-md-3 mb-3 d-flex" style="margin-left: 50%">
                    ...
                    <a href="{{ route('admin.review.trash.list') }}" class="btn btn-secondary w-100 ms-3">
                        <i class="fas fa-sync"></i> Làm mới
                    </a>
                </div>
            </form>
                    ...
                    <td>
                        ...
                        <div class="btn-group dropleft">
                            ...
                            <div class="dropdown-menu dropleft" x-placement="left-start"
                                ...
                                <form action="{{route('admin.review.trash.restore', $item->id)}}" method="post"
                                ...
                                <form action="{{route('admin.review.trash.forceDelete', $item->id)}}" method="POST"
