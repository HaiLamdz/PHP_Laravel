...
<footer class="main-footer">
  Copyright By<strong> Vũ Hải Lam</strong>
  </footer>
</div>
<!-- ./wrapper -->
...
<!-- AdminLTE -->
<script src="{{asset('assets/BE/dist/js/adminlte.js')}}"></script>

<!-- OPTIONAL SCRIPTS -->
<script src="{{asset('assets/BE/plugins/chart.js/Chart.min.js')}}"></script>
<!-- AdminLTE for demo purposes -->
<script src="{{asset('assets/BE/dist/js/demo.js')}}"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="{{asset('assets/BE/dist/js/pages/dashboard3.js')}}"></script>
<!-- DataTables  & Plugins -->
